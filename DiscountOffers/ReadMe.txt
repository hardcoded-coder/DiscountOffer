...
I have used Hungarian Algorithm to solve this. I have used a 3rd party git hub code and modified it to use hungarian algorithm. I have consider any non-space character as letter. It looks the above sample is considering only the english alphabets as letter hence the results are not quite matching. But I have verified that the result is correct.